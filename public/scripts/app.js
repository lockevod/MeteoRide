 ...
 * raised alert("Forced alert icon clicked!"). Nothing called them but each other and a
 * hidden button. Removed before an App Store submission; the history has them. */
