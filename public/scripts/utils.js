(function() {
  ...
  title: "MeteoRide — Previsión para tu salida",
      ...
      best_days_label: "Días a explorar:",
      best_time_label: "Franja horaria:",
      best_morning: "Mañana",
      best_midday: "Mediodía",
      best_afternoon: "Tarde",
      best_full: "Día completo",
      best_find_button: "Buscar mejor ventana",
      best_modal_title: "Mejores opciones",
      best_choice_select: "Seleccionar",
      best_choice_close: "Cerrar",
      best_choice_duration: "Duración aprox: {mins} min",
      best_result_message: "Mejor ventana: {dt} (score {score}%)",
      best_no_data: "No hay datos disponibles para muestreo",
      best_searching: "Buscando mejores ventanas…",
      best_search_error: "Error buscando ventanas",
      best_summary_avg_precip: "Precip media: {val} mm/h",
      best_summary_max_gust: "Racha máx: {val} m/s",
      best_summary_avg_prob: "Prob. precipitación: {val}%",
      best_summary_temp: "Temp. media: {val}°C",
    },
    en: {
  ...
  title: "MeteoRide — Forecast for your ride",
      ...
      best_days_label: "Days to explore:",
      best_time_label: "Time window:",
      best_morning: "Morning",
      best_midday: "Midday",
      best_afternoon: "Afternoon",
      best_full: "Full day",
      best_find_button: "Find best window",
      best_modal_title: "Best options",
      best_choice_select: "Select",
      best_choice_close: "Close",
      best_choice_duration: "Approx. duration: {mins} min",
      best_result_message: "Best window: {dt} (score {score}%)",
      best_no_data: "No data available for sampling",
      best_searching: "Searching for best windows…",
      best_search_error: "Error searching windows",
      best_summary_avg_precip: "Avg precip: {val} mm/h",
      best_summary_max_gust: "Max gust: {val} m/s",
      best_summary_avg_prob: "Precip prob: {val}%",
      best_summary_temp: "Avg temp: {val}°C",
    },
  };
